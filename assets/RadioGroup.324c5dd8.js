...
`,[c("splitor",`
 ...
 `)])]);function xe(e,o,t){var n;const a=[];let f=!1;for(let r=0;r<e.length;++r){const s=e[r],d=(n=s.type)===null||n===void 0?void 0:n.name;d==="RadioButton"&&(f=!0);const v=s.props;if(d!=="RadioButton"){a.push(s);continue}if(r===0)a.push(s);else{const g=a[a.length-1].props,x=o===g.value,b=g.disabled,C=o===v.value,m=v.disabled,w=(x?2:0)+(b?0:1),z=(C?2:0)+(m?0:1),k={[`${t}-radio-group__splitor--disabled`]:b,[`${t}-radio-group__splitor--checked`]:x},i={[`${t}-radio-group__splitor--disabled`]:m,[`${t}-radio-group__splitor--checked`]:C},l=w<z?i:k;a.push(y("div",{class:[`${t}-radio-group__splitor`,l]}),s)}}return{children:a,isButtonGroup:f}}const Ce=Object.assign(Object.assign({},I.props),{name:String,value:[String,Number],defaultValue:{type:[String,Number],default:null},size:String,disabled:{type:Boolean,default:void 0},"onUpdate:value":[Function,Array],onUpdateValue:[Function,Array]}),Se=G({name:"RadioGroup",props:Ce,setup(e){const o=$(null),{mergedSizeRef:t,mergedDisabledRef:n,nTriggerFormChange:a,nTriggerFormInput:f,nTriggerFormBlur:r,nTriggerFormFocus:s}=M(e),{mergedClsPrefixRef:d,inlineThemeDisabled:v,mergedRtlRef:g}=U(e),x=I("Radio","-radio-group",me,J,e,d),b=$(e.defaultValue),C=A(e,"value"),m=O(C,b);function w(u){const{onUpdateValue:p,"onUpdate:value":B}=e;p&&D(p,u),B&&D(B,u),b.value=u,a(),f()}function z(u){const{value:p}=o;!p||p.contains(u.relatedTarget)||s()}function k(u){const{value:p}=o;!p||p.contains(u.relatedTarget)||r()}ue(q,{mergedClsPrefixRef:d,nameRef:A(e,"name"),valueRef:m,disabledRef:n,mergedSizeRef:t,doUpdateValue:w});const i=N("Radio",g,d),l=F(()=>{const{value:u}=t,{common:{cubicBezierEaseInOut:p},self:{buttonBorderColor:B,buttonBorderColorActive:H,buttonBorderRadius:T,buttonBoxShadow:W,buttonBoxShadowFocus:Y,buttonBoxShadowHover:Z,buttonColorActive:Q,buttonTextColor:X,buttonTextColorActive:ee,buttonTextColorHover:oe,opacityDisabled:te,[V("buttonHeight",u)]:re,[V("fontSize",u)]:ne}}=x.value;return{"--n-font-size":ne,"--n-bezier":p,"--n-button-border-color":B,"--n-button-border-color-active":H,"--n-button-border-radius":T,"--n-button-box-shadow":W,"--n-button-box-shadow-focus":Y,"--n-button-box-shadow-hover":Z,"--n-button-color-active":Q,"--n-button-text-color":X,"--n-button-text-color-hover":oe,"--n-button-text-color-active":ee,"--n-height":re,"--n-opacity-disabled":te}}),h=v?K("radio-group",F(()=>t.value[0]),l,e):void 0;return{selfElRef:o,rtlEnabled:i,mergedClsPrefix:d,mergedValue:m,handleFocusout:k,handleFocusin:z,cssVars:v?void 0:l,themeClass:h==null?void 0:h.themeClass,onRender:h==null?void 0:h.onRender}},render(){var e;const{mergedValue:o,mergedClsPrefix:t,handleFocusin:n,handleFocusout:a}=this,{children:f,isButtonGroup:r}=xe(ce(be(this)),o,t);return(e=this.onRender)===null||e===void 0||e.call(this),y("div",{onFocusin:n,onFocusout:a,ref:"selfElRef",class:[`${t}-radio-group`,this.rtlEnabled&&`${t}-radio-group--rtl`,this.themeClass,r&&`${t}-radio-group--button-group`],style:this.cssVars},f)}});export{we as _,Se as a,J as r};
